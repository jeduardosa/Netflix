...
class DashMenuActivity : AppCompatActivity() {
    ...
    private val series = listOf(
        Series("Breaking Bad", "     Conta a história de Walter White, um professor de química do ensino médio, que, diagnosticado com" +
                ...
                "acompanha a transformação de Walter de um homem pacato a um poderoso chefão do crime.", R.drawable.breakingbad),
        Series("Brooklyn 99", "    É uma comédia policial que acompanha a vida de uma equipe de detetives da 99ª Delegacia de Polícia"+
                ...
                "por Holt.",R.drawable.brooklyn),
        Series("House", "    Acompanha o Dr. Gregory House, um médico brilhante, mas anti-social, que trabalha no Hospital" +
                ...
                "também a vida pessoal de House e seus relacionamentos com seus colegas e pacientes.",R.drawable.drhouse),
        Series("The Office", "    É uma sitcom que acompanha o dia a dia de um escritório da empresa fictícia Dunder Mifflin, em Scranton," +
                ...
                "engraçados e identificáveis.",R.drawable.theoffice)
    )
